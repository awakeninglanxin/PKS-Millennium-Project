...
def main():
    ...
    generator.save_to_dxf('非线性扭转2^n 羚羊角蛋面locas+sun螺旋_1.dxf')
    ...
    generator.twist = -1
    generator.set_default_psi()
    generator.save_to_dxf('非线性扭转羚2^n 羊角蛋面locas+sun螺旋_2.dxf')
    ...
    generator.save_to_dxf('非线性扭转羚2^n 羊角蛋面locas+sun螺旋_3.dxf')
