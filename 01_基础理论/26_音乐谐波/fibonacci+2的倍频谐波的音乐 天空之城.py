...
def save_audio_to_wav(audio_signal, sample_rate, filename="castle_in_the_sky_correct.wav"):
    """保存音频为WAV文件"""
...
def main():
    ...
    try:
        ...
        # 保存为WAV文件
        filename = "castle_in_the_sky_correct.wav"
