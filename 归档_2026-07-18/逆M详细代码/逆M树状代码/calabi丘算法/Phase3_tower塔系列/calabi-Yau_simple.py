...
def update(frame):
    ...
    # 在图中标记顶点的数量
    ax.text2D(0.5, 0.95, f"Vertices count: {vertices_count}", transform=ax.transAxes, fontsize=12, color='red',
...
# filename = f'正侧视图_颜色hsv_{n}极_{slices}片.gif'
# ani.save(filename, writer=PillowWriter(fps=slices // 4))
# plt.close()
