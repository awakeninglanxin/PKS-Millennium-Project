...
WIDTH=3200;HEIGHT=int(WIDTH*(RE_MAX-RE_MIN)/(IM_MAX-IM_MIN))
...
if __name__=='__main__':
    ...
    print(f"=== v8 高分辨率精调版 === {WIDTH}x{HEIGHT} iter={MAX_ITER}")
    ...
    out=os.path.join(out_dir,'最美的蓝色水滴分形_v8.png')
