...
# Generate points
t_values = np.linspace(2*np.pi, 20*np.pi, 3000)  # Avoid t=0 to prevent division by zero
x_values = x(t_values)
y_values = y(t_values)
z_values = z(t_values)

# Generate central axis points
z_axis = np.linspace(-10*a, 10*a, 300)
...
file_name = "3d_spiral_with_axis-tube1.dxf"
