...
class SpiralSweepGenerator:
    def __init__(self, start_dxf_path, middle_dxf_path, end_dxf_path, bottom=300, high=300, n_turns=1.5,
                 ...
                 phase_dif=0, middle_turn=1, k=0.2):
        """
...
if __name__ == "__main__":
    ...
    for bands_value, phase_dif_value in zip(bands_list, phase_dif_list):
        ...
        # 保存到DXF文件
        curve_generator.save_to_dxf(f'波纹螺旋锥管小_{bands_value}段波_相位差{phase_dif_value:.2f}.dxf', bands_list)
