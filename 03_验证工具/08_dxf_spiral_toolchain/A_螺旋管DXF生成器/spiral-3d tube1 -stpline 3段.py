...
sys.path.append('D:/Program Files/FreeCAD 0.21/bin')
...
user_input = input("Enter the parameters (default: 18 180 180 180 0 2 4): ")
if not user_input.strip():
    user_input = "18 180 180 180 0 2 4"

# Process the input
row_list = list(map(int, user_input.replace('*', '').split()))
turns = row_list[0]
a_values = row_list[1:4]
n_values = row_list[4:]
