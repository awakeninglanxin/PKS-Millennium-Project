...
def extract_spline_from_dxf(dxf_path, num_points=34):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('dxf_path', nargs='?', default="your_curve口朝右上.dxf",
                        help='DXF文件路径')
    parser.add_argument('--output', '-o', default="spline_points口朝右上.csv",
                        help='输出CSV文件路径')
    parser.add_argument('--points', '-n', type=int, default=34,
                        help='采样点数量')
